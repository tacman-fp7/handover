...
public:
    ...
    {
        module_name=rf.check("module_name", Value("CloudExtraction"), "Getting module name").asString();
        ...
        seedAuto = (rf.check("seedAuto", Value("yes"), "Automatic seed computation").asString()=="yes");
