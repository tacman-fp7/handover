...
/**
 * \defgroup periPersonalSpace periPersonalSpace
 *  
 * Classes and libraries related to the periPersonalSpace project.
 *  
 * \author Alessandro Roncone - Ugo Pattacini 
 *  
 * \defgroup iKinFwdModLib iKinFwdModLib
 *  
...
*
* A Base class for defining a Link. It's a father class, from
* which all of the other links are derived. Very similar to the
* iKinLink used in iKin.
*  
*/
...
* Denavit-Hartenberg convention ("Direct DH convention"). 
*  
...
* Denavit-Hartenberg convention ("Inverted DH convention"). 
*  
* \note This class implements revolute joints only, as they are 
*       the unique type of joints used in humanoid robotics.
*/
...
* It inherits from the iKinLinkFather class for the sake of coherence
* and code cleanliness, but most of its methods are simply useless in 
* this class.
*  
*/
/****************************************************************/
...
* \ingroup iKinFwdModLib
*
* A Base class for defining a Serial Link Chain, that is able to cope 
* with the more generic definition given by iKinLinkFather.
...
* \ingroup iKinFwdModLib
*
* A class for defining generic Limb, that is able to cope 
* with the more generic definition given by iKinLinkFather.
* It's basically the same as iKinLimb.
*
*/
...
class iCubCustomLimb : public iKinLimbMod
{
    ...
    public:
        ...
        * @param cust_limb is the object to be copied.
        */
        ...
        * @param q is the joint Vector, that has to be sent in the straightforward,
        *          usual way, i.e. the joints of the "inverted" part of the chain have
        *          to be set accordingly. Please refer to the subsequent function in 
...
* \ingroup iKinFwdModLib
*
* Class for dealing with iCub shoulder's constraints due to the cables lenght.
