...
class Localizer
{
     ...
     */
    virtual void saveData(const yarp::sig::Vector &ms_particle, const int &i, const int &k, const int &l, const int &m)=0;
    ...
    /** save statics data
     */
    virtual void saveStatisticsData(const yarp::sig::Matrix &solutions, const int &i, const int &k, const int &l, const int &m)=0;
    /*******************************************************************/
